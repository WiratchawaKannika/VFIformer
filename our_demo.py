...
def main():
    ...
    parser.add_argument('--data_root', default='/media/SSD/rheology_data/',type=str)
    ...
    parser.add_argument('--save_folder', default='/media/SSD/rheology_data/test_our_demo', type=str)
